  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="font-serif text-3xl font-bold mb-6 dark:text-sand-100">Sign in</h1>
        ...
        <p className="text-sm text-center mt-4 dark:text-sand-300">
          No account? <Link to="/register" className="text-clay-600 hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
